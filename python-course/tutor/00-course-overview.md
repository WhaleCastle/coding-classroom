...
he gets to SEE (his trophy cabinet, the celebratory mirror of the private skill ledger). It
is **generated by a script** (`tools/render_sheet.py`) from the facts the tutor records in
`progress.md` — the tutor never edits the sheet, just the facts. Details: AGENTS.md "The
